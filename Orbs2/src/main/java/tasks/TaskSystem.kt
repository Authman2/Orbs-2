    ...
    companion object TaskSystem {
        ...
        *********************/
        ...
        public var tasks: ArrayList<Task> = arrayListOf( 
            ...
            Task(id = "COOKIES", description = "Bring a batch of cookies to the desperate mother for her daughter's birthday party."),
            Task(id = "POWER_PLANT", description = "Find the switch in the power plant to help the worker fix the town's electrical problem."),
